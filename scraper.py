...
class ScraperGUI:
    def __init__(self, root):
        ...
        # (d) Délai minimum
        ttk.Label(main_frame, text="Délai minimum (s) :").grid(row=3, column=0, sticky="w", pady=2)
        ...
        self.min_delay_entry.grid(row=3, column=1, sticky="w", padx=5, pady=2)
    
        # (e) Délai maximum
        ttk.Label(main_frame, text="Délai maximum (s) :").grid(row=4, column=0, sticky="w", pady=2)
        ...
        self.max_delay_entry.grid(row=4, column=1, sticky="w", padx=5, pady=2)
    
        # (f) Nombre de threads
        ttk.Label(main_frame, text="Nombre de threads :").grid(row=5, column=0, sticky="w", pady=2)
        ...
        self.concurrency_entry.grid(row=5, column=1, sticky="w", padx=5, pady=2)
    
        # (g) Limite de URLs
        ttk.Label(main_frame, text="Limite de URLs (0 = illimité) :").grid(row=6, column=0, sticky="w", pady=2)
        self.limit_var = tk.IntVar(value=0)
        self.limit_entry = ttk.Entry(main_frame, textvariable=self.limit_var, width=10)
        self.limit_entry.grid(row=6, column=1, sticky="w", padx=5, pady=2)
    
        # (h) Activer JavaScript via Playwright
